...
public class ThreadSafeSingleton {
    ...
    private ThreadSafeSingleton() {
        System.out.println("CreationalsDesignPatterns.Singleton(): Initializing Instance");
    }
    ...
    */
    public void doSomething() {
        System.out.println("doSomething(): CreationalsDesignPatterns.Singleton does something!");
    }
}
